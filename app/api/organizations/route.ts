...
export async function POST(req: NextRequest) {
  ...
  const rows = await sql`
    INSERT INTO organizations (name, category, region, owner_type, owner_id, notes)
    VALUES (${d.name}, ${d.category || null}, ${d.region || null}, ${d.owner_type || null}, ${d.owner_id || null}, ${d.notes || ''})
    RETURNING *`;
