...
const GROUPS: Group[] = [
  {
    ...
    items: [
      ...
      { label: "ניהול יועצים", path: "/admin/advisors-team", dot: "#60A5FA" },
      { label: "ניהול מוקד", path: "/admin/call-center", dot: "#60A5FA" },
  ...
  },
  {
    ...
    items: [
      ...
      { label: "תקציב שטח", path: "/admin/field-budget", dot: "#FBBF24" },
      { label: "ניהול רכזים", path: "/admin/reports", dot: "#34D399", badgeKey: "missingReports" },
      { label: "דשבורד קהילה", path: "/admin/community-dashboard", dot: "#60A5FA" },
